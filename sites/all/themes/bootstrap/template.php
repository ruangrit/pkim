...
function bootstrap_preprocess_views_view(&$vars) {
  ...
  if ($view->name == 'menu') {
    ...
    drupal_add_js(drupal_get_path('module', 'druprong').'/menu.js');
    drupal_add_js(drupal_get_path('module', 'druprong').'/jquery.tooltipster.min.js');
    drupal_add_css(drupal_get_path('module', 'druprong').'/tooltipster.css');
  }
}
