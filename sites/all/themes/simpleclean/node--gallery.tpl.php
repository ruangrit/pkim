...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  <div class="node-inner clearfix">
    ...
    <div class="node-content"<?php print $content_attributes; ?>>
     <div id="s2" class="pics" style="position: relative; max-height: 500px; overflow:hidden;">
      <?php
        foreach($content['field_gallery']['#items'] as $image) {
          $path = file_create_url($image['uri']);
      ?>
          <img src="<?php print $path ?>"  style="position: absolute; top: 0px; left: 0px; display: none; z-index: 3; opacity: 0; max-height:500px">
      <?php
        }
      ?>
     </div>
